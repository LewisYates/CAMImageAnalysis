...
filelist = dir([fileparts('/Users/LewisYates/Documents/MATLAB/Dissertation/Training/') filesep '*.JPG']);
...
featureFunctions = {
            ...
            @(block_struct) gradient(double(double(block_struct.data))), ...
            @(block_struct) gradient(gradient(double(double(block_struct.data))))...
            @(block_struct) rangefilt(double(double(block_struct.data)))
    };

%Loop through all of the images/feature patches
